...
[root@localhost ~]# parted /dev/sdb mkpart primary 0 100%
Warning: The resulting partition is not properly aligned for best performance.
Ignore/Cancel? I                                                          
Information: You may need to update /etc/fstab.
```
...
```
[root@localhost ~]#  vgcreate vgdata /dev/sda1
...
```
[root@localhost ~]#  lvcreate -l 100%VG -n  lvdata vgdata 
...
```
[root@localhost ~]#  mkfs -t xfs /dev/vgdata/lvdata
