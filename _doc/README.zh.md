...
### [我的博客在这里 &rarr;](https://dasher-zdh.github.io/)
...
我的博客仓库——`dasher-zdh.github.io`，是经常修改的，而且还会有人乱提交代码，因此给大家做了一个稳定版的模板。大家可以直接fork模板——`huxblog-boilerplate`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。
...
* 解决了代码过长自动换行的bug,替换为横向滚动条。详情请见[issue#15](https://dasher-zdh.github.io/issues/15)
...
* 如果你喜欢我的这个博客模板，请在`dasher-zdh.github.io`这个repository点个赞——右上角**star**一下。
...
我的博客标题是 **“Hux Blog”** 但是我想要在搜索的时候显示 **“无妄居士的博客 | Hux Blog”** ，这个就需要SEO Title来定义了。
